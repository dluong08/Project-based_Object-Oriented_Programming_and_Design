...
public class Follower extends Execute {
    ...
    public void transformToDude(
            WorldModel world,
            EventScheduler scheduler,
            ImageStore imageStore) {

            List<PImage> images = imageStore.getImageList("dude");

            Entity miner = Functions.createDudeFull(Functions.DUDE_KEY,
    ...
    {
        /*
        if (Functions.adjacent(this.getPosition(), target.getPosition())) { // might break
